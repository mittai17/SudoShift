...
export default function TimerNode({ data }: { data: NodeData }) {
  ...
  return (
    <NodeWrapper>
      <div className="flex flex-col w-64 rounded-xl shadow-md bg-[#13141c] border border-[#2a2b36]  transition-shadow hover:shadow-lg nodrag">
      ...
      <div className="p-4 bg-[#13141c] flex flex-col items-center space-y-4 cursor-default">
         <div className="flex space-x-1 bg-gray-100 p-1 rounded-lg w-full justify-center">
             <button onClick={() => switchMode('work')} className={`flex-1 py-1 text-[10px] sm:text-xs rounded shadow-sm transition-colors ${mode === 'work' ? 'bg-[#13141c] font-semibold text-rose-500' : 'text-gray-500 hover:text-gray-300'}`}>Work</button>
             <button onClick={() => switchMode('short_break')} className={`flex-1 py-1 text-[10px] sm:text-xs rounded shadow-sm transition-colors ${mode === 'short_break' ? 'bg-[#13141c] font-semibold text-rose-500' : 'text-gray-500 hover:text-gray-300'}`}>Short</button>
             <button onClick={() => switchMode('long_break')} className={`flex-1 py-1 text-[10px] sm:text-xs rounded shadow-sm transition-colors ${mode === 'long_break' ? 'bg-[#13141c] font-semibold text-rose-500' : 'text-gray-500 hover:text-gray-300'}`}>Long</button>
         </div>
         ...
         <div className="flex items-center space-x-4">
             ...
             <button onClick={resetTimer} className="p-2 text-gray-400 hover:text-gray-400 bg-[#1a1b23] hover:bg-gray-100 rounded-full transition-colors">
