...
export default function HowItWorks() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-gray-900 font-sans selection:bg-[#6366f1] selection:text-white">
      ...
      <main className="mx-auto max-w-6xl px-4 md:px-6 lg:px-12 py-16 md:py-20">
        <section>
          <div className="mb-12">
            <p className="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-2">How it Works</p>
            <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-gray-900 mb-4">Clarity in the Working</h1>
