...
export type EisenhowerMatrix =
  ...
  | 'RESOURCE' | 'RESOURCE_VIDEO' | 'RESOURCE_LINK' | 'RESOURCE_NOTE' | 'RESOURCE_IMAGE' | 'RESOURCE_PDF' | 'RESOURCE_YOUTUBE_TRANSCRIBE' | 'RESOURCE_OUTPUT' | 'RESOURCE_ROADMAP_MAKER' | 'RESOURCE_CANVAS' | 'RESOURCE_YOUTUBE_API'
  | 'NOTE_NODE' | 'NOTE_IMAGE' | 'NOTE_CODE' | 'NOTE_MERMAID' | 'NOTE_FORMULA' | 'NOTE_TABLE' | 'NOTE_LINK'
  // Integrations
  | 'INTEGRATION_NOTION' | 'INTEGRATION_GITHUB' | 'INTEGRATION_SLACK' | 'INTEGRATION_AIRTABLE' | 'INTEGRATION_JIRA' | 'INTEGRATION_ZAPIER' | 'INTEGRATION_MAKE' | 'INTEGRATION_OBSIDIAN' | 'INTEGRATION_GSHEETS' | 'INTEGRATION_TRELLO' | 'INTEGRATION_LINEAR' | 'INTEGRATION_DISCORD' | 'INTEGRATION_MICROSOFT' | 'INTEGRATION_MCP'
